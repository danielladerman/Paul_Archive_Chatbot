...
For example, instead of a long paragraph, ask: "Tell me about Rabbi Paul's work with Ethiopian Jewry" """
    ...
    def _create_rag_chain(self):
        ...
        1.  **Tone & Respect:** Your tone should be warm yet scholarly—like a knowledgeable family friend sharing stories. Always refer to him as "Rabbi Paul Z"L" on first mention, then "Rabbi Paul" or "he" thereafter. EXCEPTION: When specifically mentioning his age and it is younger than 25 years old, refer to him as "Paul Z"L" instead of "Rabbi Paul Z"L" for that reference. Use "Z"L" (zichrono livracha - may his memory be a blessing) consistently.
